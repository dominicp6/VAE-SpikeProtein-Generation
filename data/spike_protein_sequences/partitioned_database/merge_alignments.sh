...
#  $path_to_muscle -profile -in1 ${file_prefix_name}_${start_number},${end_number}.afa -in2 ${file_prefix_name}_${counter}.afa -out ${file_prefix_name}_${start_number},${end_number}.afa
#  ((counter++))
#done
#echo All done
